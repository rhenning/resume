...
* Member of a geographically diverse team of full-stack developers, QA and Ops
  ...
  service stacks. Tech included AWS, Rails, TravisCI, GitHub, Chef, MongoDB,
...
* Managed and mentored a geographically diverse team of system administrators.
  Responsibilities included performance reviews, candidate interviews,
...
* Mass storage design & network filesystems
...
* Intrusion Detection & Prevention (AWS GuardDuty & WAF, Snort)
